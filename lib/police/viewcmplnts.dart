...
class Viewcmplnts extends StatelessWidget {
  Viewcmplnts({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: const Color.fromARGB(255, 221, 165, 231),
      ),
          ...
          return Padding(
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [Text(complaints[index]['contact no.'])],
              ),
